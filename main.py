...
min_dict = {time_list[0]: 500, time_list[1]: 1000, time_list[2]: 3000, time_list[3]: 12000, time_list[4]: 27000, time_list[5]: 39000, time_list[6]: 58000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 999, time_list[1]: 2999, time_list[2]: 11999, time_list[3]: 26999, time_list[4]: 38999, time_list[5]: 57999, time_list[6]: 66999}
# 设置结束
now = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
headers = {'User-Agent': 'MiFit/5.3.0 (iPhone; iOS 15.3.1; Scale/3.00)'}
